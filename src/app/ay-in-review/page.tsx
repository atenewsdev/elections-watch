...
//   title: "AY in Elections Watch 2026",
//   description: "Atenews Elections Watch 2026",
//   openGraph: {
//     title: "Elections Watch 2026",
//     description: "Atenews Elections Watch 2026",
//     url: "https://elections-watch-2026.atenews.ph/ay-in-review",
//     images: [
//       {
      ...
      <article className="w-full max-w-271 px-10 flex flex-col gap-10 py-14">
        ...
        <div className="flex flex-col gap-12">
          <div className="flex flex-col gap-6">
            ...
            <span className="self-start px-6 py-2.5 bg-amber-400 rounded-full text-white text-2xl font-semibold font-montserrat">
              A Year in Review
            </span>

        ...
        <div className="relative z-10 flex flex-col items-center gap-3 md:gap-4 px-8 md:px-4 w-full">
          {showLogo && (
            <div className="flex items-center gap-2">
              <Image src="/logo-white.png" alt="Atenews Logo" width={28} height={28} className="md:w-8 md:h-8" />
              <Image src="/logotype-white.png" alt="Atenews" width={88} height={23} className="md:w-25 md:h-6.5" />
            </div>
          )}
